...
var G__23042 = o;
reagent.impl.template.goog$module$goog$object.set(G__23042,reagent.impl.template.cached_prop_name(k),(reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1(v) : reagent.impl.template.convert_prop_value.call(null,v)));
...
return (function() { 
var G__23060__delegate = function (args){
...
while (G__23061__i < G__23061__a.length) {G__23061__a[G__23061__i] = arguments[G__23061__i + 0]; ++G__23061__i;}
  args = new cljs.core.IndexedSeq(G__23061__a,0,null);
} 
return G__23060__delegate.call(this,args);};
...
return G__23060__delegate(args);
});
...
var G__23043 = o;
reagent.impl.template.goog$module$goog$object.set(G__23043,reagent.impl.template.cached_custom_prop_name(k),reagent.impl.template.convert_prop_value(v));
...
if(cljs.core.ifn_QMARK_(x)){
return (function() { 
var G__23063__delegate = function (args){
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(x,args);
};
...
while (G__23064__i < G__23064__a.length) {G__23064__a[G__23064__i] = arguments[G__23064__i + 0]; ++G__23064__i;}
  args = new cljs.core.IndexedSeq(G__23064__a,0,null);
} 
return G__23063__delegate.call(this,args);};
G__23063.cljs$lang$maxFixedArity = 0;
G__23063.cljs$lang$applyTo = (function (arglist__23065){
var args = cljs.core.seq(arglist__23065);
return G__23063__delegate(args);
});
...
var G__23044 = props;
var G__23044__$1 = (((((!((id == null)))) && ((new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(props) == null))))?cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__23044,new cljs.core.Keyword(null,"id","id",-1388402092),id):G__23044);
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__23044__$1,new cljs.core.Keyword(null,"class","class",-2030961996),reagent.impl.util.class_names.cljs$core$IFn$_invoke$arity$2(class$,(function (){var or__5045__auto__ = new cljs.core.Keyword(null,"class","class",-2030961996).cljs$core$IFn$_invoke$arity$1(props);
...
var props__$1 = reagent.impl.template.set_id_class((function (){var G__23045 = props;
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__23045,new cljs.core.Keyword(null,"class","class",-2030961996),reagent.impl.util.class_names.cljs$core$IFn$_invoke$arity$1(class$));
} else {
return G__23045;
}
})(),id_class);
...
var G__23046 = (cljs.core.count(argv) - first_child);
switch (G__23046) {
case (0):
...
var vec__23047 = cljs.core.next(cljs.core.re_matches(reagent.impl.template.re_tag,cljs.core.name(hiccup_tag)));
var tag = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__23047,(0),null);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__23047,(1),null);
var className = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__23047,(2),null);
...
var temp__5808__auto___23069 = reagent.impl.util.react_key_from_vec(v);
if((temp__5808__auto___23069 == null)){
} else {
var key_23070 = temp__5808__auto___23069;
(jsprops.key = key_23070);
}
...
var temp__5808__auto___23072 = reagent.impl.util.react_key_from_vec(v);
if((temp__5808__auto___23072 == null)){
} else {
var key_23074 = temp__5808__auto___23072;
(jsprops.key = key_23074);
}
...
var temp__5808__auto___23077 = reagent.impl.util.react_key_from_vec(argv);
if((temp__5808__auto___23077 == null)){
} else {
var key_23078 = temp__5808__auto___23077;
(jsprops.key = key_23078);
}
...
var temp__5808__auto___23083 = reagent.impl.util.get_react_key(cljs.core.meta(argv));
if((temp__5808__auto___23083 == null)){
} else {
var key_23084 = temp__5808__auto___23083;
(jsprops.key = key_23084);
}
...
var temp__5808__auto___23086 = reagent.impl.util.get_react_key(cljs.core.meta(argv));
if((temp__5808__auto___23086 == null)){
} else {
var key_23087 = temp__5808__auto___23086;
...
return cljs.core.into_array.cljs$core$IFn$_invoke$arity$1(cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__23050_SHARP_){
return reagent.impl.protocols.as_element(compiler,p1__23050_SHARP_);
}),s));
});
...
var ctx = ({});
var vec__23051 = reagent.ratom.check_derefs((function (){
return reagent.impl.template.expand_seq_dev(x,ctx,compiler);
}));
var res = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__23051,(0),null);
var derefed = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__23051,(1),null);
...
break;
default:
var G__23098 = cljs.core.with_meta(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.cljs$core$IFn$_invoke$arity$3(n,(0),pos),cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(cljs.core.with_meta(v,null),(0),cljs.core.subs.cljs$core$IFn$_invoke$arity$2(n,(pos + (1))))], null),cljs.core.meta(v));
var G__23099 = compiler;
v = G__23098;
compiler = G__23099;
continue;
...
var G__23055 = tag;
var G__23055__$1 = (((G__23055 instanceof cljs.core.Keyword))?G__23055.fqn:null);
switch (G__23055__$1) {
case ">":
...
*/
reagent.impl.template.t_reagent$impl$template23057 = (function (opts,id,fn_to_element,parse_fn,meta23058){
this.opts = opts;
this.id = id;
this.fn_to_element = fn_to_element;
this.parse_fn = parse_fn;
this.meta23058 = meta23058;
this.cljs$lang$protocol_mask$partition0$ = 393216;
this.cljs$lang$protocol_mask$partition1$ = 0;
});
(reagent.impl.template.t_reagent$impl$template23057.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_23059,meta23058__$1){
var self__ = this;
var _23059__$1 = this;
return (new reagent.impl.template.t_reagent$impl$template23057(self__.opts,self__.id,self__.fn_to_element,self__.parse_fn,meta23058__$1));
}));

(reagent.impl.template.t_reagent$impl$template23057.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_23059){
var self__ = this;
var _23059__$1 = this;
return self__.meta23058;
}));

(reagent.impl.template.t_reagent$impl$template23057.prototype.reagent$impl$protocols$Compiler$ = cljs.core.PROTOCOL_SENTINEL);

(reagent.impl.template.t_reagent$impl$template23057.prototype.reagent$impl$protocols$Compiler$get_id$arity$1 = (function (this$){
var self__ = this;
var this$__$1 = this;
return self__.id;
}));

(reagent.impl.template.t_reagent$impl$template23057.prototype.reagent$impl$protocols$Compiler$parse_tag$arity$3 = (function (this$,tag_name,tag_value){
var self__ = this;
var this$__$1 = this;
...
(reagent.impl.template.t_reagent$impl$template23057.prototype.reagent$impl$protocols$Compiler$as_element$arity$2 = (function (this$,x){
var self__ = this;
var this$__$1 = this;
return reagent.impl.template.as_element(this$__$1,x,self__.fn_to_element);
}));

(reagent.impl.template.t_reagent$impl$template23057.prototype.reagent$impl$protocols$Compiler$make_element$arity$5 = (function (this$,argv,component,jsprops,first_child){
var self__ = this;
var this$__$1 = this;
return reagent.impl.template.make_element(this$__$1,argv,component,jsprops,first_child);
}));

(reagent.impl.template.t_reagent$impl$template23057.getBasis = (function (){
return new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Symbol(null,"opts","opts",1795607228,null),new cljs.core.Symbol(null,"id","id",252129435,null),new cljs.core.Symbol(null,"fn-to-element","fn-to-element",-1764467095,null),new cljs.core.Symbol(null,"parse-fn","parse-fn",-836029424,null),new cljs.core.Symbol(null,"meta23058","meta23058",-1946172707,null)], null);
}));

(reagent.impl.template.t_reagent$impl$template23057.cljs$lang$type = true);

(reagent.impl.template.t_reagent$impl$template23057.cljs$lang$ctorStr = "reagent.impl.template/t_reagent$impl$template23057");

(reagent.impl.template.t_reagent$impl$template23057.cljs$lang$ctorPrWriter = (function (this__5330__auto__,writer__5331__auto__,opt__5332__auto__){
return cljs.core._write(writer__5331__auto__,"reagent.impl.template/t_reagent$impl$template23057");
}));

/**
 * Positional factory function for reagent.impl.template/t_reagent$impl$template23057.
 */
reagent.impl.template.__GT_t_reagent$impl$template23057 = (function reagent$impl$template$__GT_t_reagent$impl$template23057(opts,id,fn_to_element,parse_fn,meta23058){
return (new reagent.impl.template.t_reagent$impl$template23057(opts,id,fn_to_element,parse_fn,meta23058));
});
...
return (new reagent.impl.template.t_reagent$impl$template23057(opts,id,fn_to_element,parse_fn,cljs.core.PersistentArrayMap.EMPTY));
});
