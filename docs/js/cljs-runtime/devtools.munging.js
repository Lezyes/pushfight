...
var temp__5802__auto____$1 = (o12211["core"]);
if(cljs.core.truth_(temp__5802__auto____$1)){
var o12212 = temp__5802__auto____$1;
return (o12212["js_reserved_QMARK_"]);
} else {
return null;
}
} else {
...
var o__11444__auto__ = f;
return (o__11444__auto__["toString"]).call(o__11444__auto__);
} else {
return "";
}
}catch (e12222){var _ = e12222;
return "";
}});
...
try{var o__11444__auto___12613 = t;
(o__11444__auto___12613["cljs$lang$ctorPrWriter"]).call(o__11444__auto___12613,t,writer);
}catch (e12235){var __12614 = e12235;
}
...
var char_code = (function (){var o__11444__auto__ = (new String(char$));
return (o__11444__auto__["charCodeAt"]).call(o__11444__auto__,(0));
})();
var num_code = (char_code - (48));
var subscript_code = ((8320) + num_code);
var o__11444__auto__ = String;
return (o__11444__auto__["fromCharCode"]).call(o__11444__auto__,subscript_code);
});
/**
...
var num_code = (char_code - (48));
var superscript_code = (function (){var G__12262 = num_code;
switch (G__12262) {
case (1):
return (185);
...
var o__11444__auto__ = String;
return (o__11444__auto__["fromCharCode"]).call(o__11444__auto__,superscript_code);
});
/**
...
}catch (e12300){var _e__11460__auto__ = e12300;
return false;
}})())){
...
var vec__12305 = devtools.munging.parse_fn_source(fn_source);
var name__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12305,(0),null);
...
(devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic = (function (tokens,p__12340){
var vec__12341 = p__12340;
var ns_detector = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12341,(0),null);
...
var G__12639 = cljs.core.concat.cljs$core$IFn$_invoke$arity$2(new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.last(remaining_tokens)], null),name_tokens);
var G__12640 = cljs.core.butlast(remaining_tokens);
name_tokens = G__12639;
remaining_tokens = G__12640;
continue;
}
}
break;
...
/** @this {Function} */
(devtools.munging.detect_namespace_prefix.cljs$lang$applyTo = (function (seq12336){
var G__12337 = cljs.core.first(seq12336);
var seq12336__$1 = cljs.core.next(seq12336);
var self__5754__auto__ = this;
return self__5754__auto__.cljs$core$IFn$_invoke$arity$variadic(G__12337,seq12336__$1);
}));
...
var vec__12353 = cljs.core.split_with((function (p1__12352_SHARP_){
return cljs.core.not_EQ_.cljs$core$IFn$_invoke$arity$2(p1__12352_SHARP_,"arity");
}),tokens);
var prefix_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12353,(0),null);
var arity_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12353,(1),null);
...
var vec__12362 = devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic(remaining_tokens,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([detector], 0));
var protocol_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12362,(0),null);
var name_and_method_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12362,(1),null);
if(cljs.core.empty_QMARK_(protocol_ns)){
var G__12645 = cljs.core.rest(remaining_tokens);
var G__12646 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(name_tokens,cljs.core.first(remaining_tokens));
remaining_tokens = G__12645;
name_tokens = G__12646;
continue;
} else {
...
var vec__12375 = devtools.munging.strip_arity(tokens);
var tokens__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12375,(0),null);
var arity = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12375,(1),null);
var vec__12378 = devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic(tokens__$1,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([effective_detector], 0));
var fn_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12378,(0),null);
var tokens__$2 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12378,(1),null);
var vec__12381 = devtools.munging.parse_protocol(tokens__$2,effective_detector);
var fn_name_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12381,(0),null);
var protocol_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12381,(1),null);
var protocol_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12381,(2),null);
var protocol_method_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12381,(3),null);
...
var vec__12393 = result;
var munged_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12393,(0),null);
var munged_name__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12393,(1),null);
var munged_protocol_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12393,(2),null);
var munged_protocol_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12393,(3),null);
var munged_protocol_method = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12393,(4),null);
var arity = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12393,(5),null);
...
if(cljs.core.truth_(temp__5802__auto__)){
var vec__12404 = temp__5802__auto__;
var munged_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12404,(0),null);
var args = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12404,(1),null);
var vec__12409 = devtools.munging.break_and_demunge_name.cljs$core$IFn$_invoke$arity$1(munged_name);
var ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12409,(0),null);
var name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12409,(1),null);
...
return cljs.core.concat.cljs$core$IFn$_invoke$arity$2(cljs.core.take.cljs$core$IFn$_invoke$arity$2((2),fn_info),cljs.core.drop.cljs$core$IFn$_invoke$arity$2((2),(function (){var G__12421 = cljs.core.second(cljs.core.first(arities));
return (devtools.munging.parse_fn_info_deep.cljs$core$IFn$_invoke$arity$1 ? devtools.munging.parse_fn_info_deep.cljs$core$IFn$_invoke$arity$1(G__12421) : devtools.munging.parse_fn_info_deep.call(null,G__12421));
})()));
}
} else {
return fn_info;
...
var G__12668 = (arity + (1));
var G__12669 = (function (){var temp__5802__auto__ = devtools.munging.get_fn_fixed_arity(f,arity);
if(cljs.core.truth_(temp__5802__auto__)){
...
devtools.munging.review_arity = (function devtools$munging$review_arity(p__12483){
var vec__12484 = p__12483;
var arity = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12484,(0),null);
var arity_fn = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12484,(1),null);
...
var sorted_fns = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__12502_SHARP_){
return cljs.core.get.cljs$core$IFn$_invoke$arity$2(arities,p1__12502_SHARP_);
}),sorted_keys);
var sorted_infos = cljs.core.map.cljs$core$IFn$_invoke$arity$2(devtools.munging.parse_fn_info_deep,sorted_fns);
var sorted_args_lists = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__12503_SHARP_){
return cljs.core.drop.cljs$core$IFn$_invoke$arity$2((2),p1__12503_SHARP_);
}),sorted_infos);
...
var args__5775__auto__ = [];
var len__5769__auto___12675 = arguments.length;
var i__5770__auto___12676 = (0);
while(true){
if((i__5770__auto___12676 < len__5769__auto___12675)){
args__5775__auto__.push((arguments[i__5770__auto___12676]));

var G__12680 = (i__5770__auto___12676 + (1));
i__5770__auto___12676 = G__12680;
continue;
} else {
}
break;
...
(devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic = (function (arities,p__12521){
var vec__12522 = p__12521;
var humanize_QMARK_ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12522,(0),null);
...
/** @this {Function} */
(devtools.munging.arities_to_args_lists.cljs$lang$applyTo = (function (seq12508){
var G__12510 = cljs.core.first(seq12508);
var seq12508__$1 = cljs.core.next(seq12508);
var self__5754__auto__ = this;
return self__5754__auto__.cljs$core$IFn$_invoke$arity$variadic(G__12510,seq12508__$1);
}));
...
var G__12526 = arg;
var G__12526__$1 = (((G__12526 instanceof cljs.core.Keyword))?G__12526.fqn:null);
switch (G__12526__$1) {
...
var map__12538 = options;
var map__12538__$1 = cljs.core.__destructure_map(map__12538);
var include_ns_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__12538__$1,new cljs.core.Keyword(null,"include-ns?","include-ns?",-341372810));
var include_protocol_ns_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__12538__$1,new cljs.core.Keyword(null,"include-protocol-ns?","include-protocol-ns?",989250951));
var silence_common_protocols_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__12538__$1,new cljs.core.Keyword(null,"silence-common-protocols?","silence-common-protocols?",2012431893));
var ns_detector = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__12538__$1,new cljs.core.Keyword(null,"ns-detector","ns-detector",-2041592760));
var vec__12539 = devtools.munging.break_and_demunge_name.cljs$core$IFn$_invoke$arity$2(munged_name,ns_detector);
var fn_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12539,(0),null);
var fn_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12539,(1),null);
var protocol_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12539,(2),null);
var protocol_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12539,(3),null);
var protocol_method = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12539,(4),null);
var arity = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12539,(5),null);
...
var o__11444__auto__ = f;
return (o__11444__auto__["getBasis"]).call(o__11444__auto__);
});
/**
...
}catch (e12551){var _e__11460__auto__ = e12551;
...
var G__12689 = (obj[cljs.core.first(path)]);
var G__12690 = cljs.core.rest(path);
obj = G__12689;
path = G__12690;
continue;
} else {
...
var _STAR_ = (function (accum,p__12578){
var vec__12580 = p__12578;
var bit = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12580,(0),null);
var protocol = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12580,(1),null);
...
devtools.munging.convert_to_protocol_descriptor = (function devtools$munging$convert_to_protocol_descriptor(fast_QMARK_,p__12590){
var vec__12591 = p__12590;
var ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12591,(0),null);
var name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12591,(1),null);
var selector = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12591,(2),null);
...
var post_process = (function (p__12601){
var vec__12602 = p__12601;
var munged_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12602,(0),null);
var matches__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12602,(1),null);
...
var sorted_fns = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__12597_SHARP_){
return (obj[cljs.core.first(p1__12597_SHARP_)]);
}),sorted_matches);
