...
var len__5769__auto___12730 = arguments.length;
var i__5770__auto___12731 = (0);
while(true){
if((i__5770__auto___12731 < len__5769__auto___12730)){
args__5775__auto__.push((arguments[i__5770__auto___12731]));

var G__12732 = (i__5770__auto___12731 + (1));
i__5770__auto___12731 = G__12732;
continue;
} else {
}
break;
...
/** @this {Function} */
(devtools.formatters.printing.build_markup.cljs$lang$applyTo = (function (seq12677){
...
return self__5754__auto__.cljs$core$IFn$_invoke$arity$variadic(G__12678,G__12679,seq12677__$2);
}));
...
if(cljs.core.truth_(devtools.formatters.helpers.should_render_QMARK_(new cljs.core.Keyword(null,"render-metas","render-metas",1141294116),value,(function (p1__12695_SHARP_){
return (!((cljs.core.meta(p1__12695_SHARP_) == null)));
})))){
...
var map__12700 = opts;
var map__12700__$1 = cljs.core.__destructure_map(map__12700);
var markup_db = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__12700__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}catch (e12701){var _e__11460__auto__ = e12701;
return false;
}})();
if(cljs.core.truth_(or__5045__auto__)){
return or__5045__auto__;
...
}catch (e12703){var _e__11460__auto__ = e12703;
return false;
}}
})())){
...
var _STAR_current_state_STAR__orig_val__12706 = devtools.formatters.state._STAR_current_state_STAR_;
var _STAR_current_state_STAR__temp_val__12707 = devtools.formatters.state.get_current_state();
(devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR__temp_val__12707);
...
var markup_db = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__12708__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}finally {(devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR__orig_val__12706);
}});
...
var temp__5802__auto___12753 = devtools.formatters.state.get_managed_print_level();
if(cljs.core.truth_(temp__5802__auto___12753)){
var managed_print_level_12754 = temp__5802__auto___12753;
var _STAR_print_level_STAR__orig_val__12722_12755 = cljs.core._STAR_print_level_STAR_;
var _STAR_print_level_STAR__temp_val__12723_12756 = managed_print_level_12754;
(cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR__temp_val__12723_12756);

try{devtools.formatters.state.update_current_state_BANG_((function (p1__12716_SHARP_){
return devtools.formatters.state.set_managed_print_level(p1__12716_SHARP_,null);
}));

job_fn();
}finally {(cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR__orig_val__12722_12755);
}} else {
job_fn();
}
