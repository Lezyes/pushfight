...
return ((cljs.core.fn_QMARK_(c)) && ((!(((function (){var G__22926 = c;
var G__22926__$1 = (((G__22926 == null))?null:G__22926.prototype);
if((G__22926__$1 == null)){
return null;
} else {
return G__22926__$1.reagentRender;
}
})() == null)))));
});
reagent.impl.component.react_class_QMARK_ = (function reagent$impl$component$react_class_QMARK_(c){
return ((cljs.core.fn_QMARK_(c)) && ((!(((function (){var G__22933 = c;
var G__22933__$1 = (((G__22933 == null))?null:G__22933.prototype);
if((G__22933__$1 == null)){
return null;
} else {
return G__22933__$1.render;
}
})() == null)))));
});
...
var or__5045__auto__ = (function (){var G__22971 = c;
var G__22971__$1 = (((G__22971 == null))?null:G__22971.constructor);
if((G__22971__$1 == null)){
return null;
} else {
return G__22971__$1.displayName;
}
})();
...
var G__22972 = c;
var G__22972__$1 = (((G__22972 == null))?null:G__22972.constructor);
if((G__22972__$1 == null)){
return null;
} else {
return G__22972__$1.name;
}
}
});
...
var _STAR_current_component_STAR__orig_val__22996 = reagent.impl.component._STAR_current_component_STAR_;
var _STAR_current_component_STAR__temp_val__22997 = c;
(reagent.impl.component._STAR_current_component_STAR_ = _STAR_current_component_STAR__temp_val__22997);

try{return reagent.impl.component.wrap_render(c,compiler);
}finally {(reagent.impl.component._STAR_current_component_STAR_ = _STAR_current_component_STAR__orig_val__22996);
}});
...
var c = this;
var G__23011_23027 = reagent.impl.component.goog$module$goog$object.get(c,"cljsRatom");
if((G__23011_23027 == null)){
} else {
reagent.ratom.dispose_BANG_(G__23011_23027);
}
...
var renders_23030 = cljs.core.select_keys(fmap,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"render","render",-1408033454),new cljs.core.Keyword(null,"reagentRender","reagentRender",-358306383)], null));
var render_fun_23031 = cljs.core.first(cljs.core.vals(renders_23030));
...
if((cljs.core.count(renders_23030) > (0))){
} else {
throw (new Error(["Assert failed: ","Missing reagent-render","\n","(pos? (count renders))"].join('')));
}

if(((1) === cljs.core.count(renders_23030))){
} else {
throw (new Error(["Assert failed: ","Too many render functions supplied","\n","(== 1 (count renders))"].join('')));
}

if(cljs.core.ifn_QMARK_(render_fun_23031)){
} else {
throw (new Error(["Assert failed: ",["Expected something callable, not ",cljs.core.pr_str.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([render_fun_23031], 0))].join(''),"\n","(clojure.core/ifn? render-fun)"].join('')));
}
...
var G__23012 = o;
reagent.impl.component.goog$module$goog$object.set(G__23012,cljs.core.name(k),v);
...
var _STAR_current_component_STAR__orig_val__23013 = reagent.impl.component._STAR_current_component_STAR_;
var _STAR_current_component_STAR__temp_val__23014 = c;
(reagent.impl.component._STAR_current_component_STAR_ = _STAR_current_component_STAR__temp_val__23014);

try{return reagent.impl.component.functional_wrap_render(compiler,c);
}finally {(reagent.impl.component._STAR_current_component_STAR_ = _STAR_current_component_STAR__orig_val__23013);
}});
...
var vec__23015 = module$node_modules$react$index.useState((0));
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__23015,(0),null);
var update_count = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__23015,(1),null);
...
var G__23018 = reagent.impl.component.goog$module$goog$object.get(reagent_state,"cljsRatom");
if((G__23018 == null)){
return null;
} else {
return reagent.ratom.dispose_BANG_(G__23018);
}
});
}),[]);
