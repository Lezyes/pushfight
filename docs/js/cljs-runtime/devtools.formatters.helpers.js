...
var G__12666 = devtools.prefs.pref(v);
v = G__12666;
continue;
} else {
return v;
...
}catch (e12622){var _e__11460__auto__ = e12622;
return false;
}})();
...
}catch (e12625){var _e__11460__auto__ = e12625;
return false;
}})();
...
}catch (e12627){var _e__11460__auto__ = e12627;
return false;
}}
}
});
...
var vec__12636 = devtools.munging.parse_constructor_info(constructor_fn);
var ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12636,(0),null);
var name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12636,(1),null);
...
return cljs.core.some((function (p1__12649_SHARP_){
return cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(devtools.formatters.helpers.pref(new cljs.core.Keyword(null,"more-marker","more-marker",-14717935)),p1__12649_SHARP_);
}),template);
});
