...
var len__5769__auto___12560 = arguments.length;
var i__5770__auto___12562 = (0);
while(true){
if((i__5770__auto___12562 < len__5769__auto___12560)){
...
/** @this {Function} */
(devtools.formatters.state.update_current_state_BANG_.cljs$lang$applyTo = (function (seq12461){
...
return cljs.core.some((function (p1__12488_SHARP_){
return (p1__12488_SHARP_ === object);
}),history__$1);
});
...
(devtools.formatters.state.present_path_segment.cljs$core$IFn$_invoke$arity$variadic = (function (v,p__12497){
var vec__12498 = p__12497;
var starting_index = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12498,(0),null);
if(typeof v === 'string'){
return v;
} else {
...
/** @this {Function} */
(devtools.formatters.state.present_path_segment.cljs$lang$applyTo = (function (seq12494){
var G__12495 = cljs.core.first(seq12494);
var seq12494__$1 = cljs.core.next(seq12494);
var self__5754__auto__ = this;
return self__5754__auto__.cljs$core$IFn$_invoke$arity$variadic(G__12495,seq12494__$1);
}));
...
(devtools.formatters.state.seek_path_segment.cljs$core$IFn$_invoke$arity$variadic = (function (coll,val,p__12513){
var vec__12514 = p__12513;
var seq_SINGLEQUOTE_d_map_QMARK_ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12514,(0),null);
...
/** @this {Function} */
(devtools.formatters.state.seek_path_segment.cljs$lang$applyTo = (function (seq12505){
...
var self__5754__auto__ = this;
return self__5754__auto__.cljs$core$IFn$_invoke$arity$variadic(G__12506,G__12507,seq12505__$2);
}));
