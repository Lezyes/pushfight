...
var cljs$core$async$impl$protocols$ReadPort$take_BANG_$dyn_15345 = (function (port,fn1_handler){
...
return cljs$core$async$impl$protocols$ReadPort$take_BANG_$dyn_15345(port,fn1_handler);
}
});
...
var cljs$core$async$impl$protocols$WritePort$put_BANG_$dyn_15346 = (function (port,val,fn1_handler){
var x__5393__auto__ = (((port == null))?null:port);
...
return cljs$core$async$impl$protocols$WritePort$put_BANG_$dyn_15346(port,val,fn1_handler);
}
});
...
var cljs$core$async$impl$protocols$Channel$close_BANG_$dyn_15350 = (function (chan){
...
return cljs$core$async$impl$protocols$Channel$close_BANG_$dyn_15350(chan);
}
});

var cljs$core$async$impl$protocols$Channel$closed_QMARK_$dyn_15355 = (function (chan){
var x__5393__auto__ = (((chan == null))?null:chan);
...
return cljs$core$async$impl$protocols$Channel$closed_QMARK_$dyn_15355(chan);
}
});
...
var cljs$core$async$impl$protocols$Handler$active_QMARK_$dyn_15360 = (function (h){
...
return cljs$core$async$impl$protocols$Handler$active_QMARK_$dyn_15360(h);
}
});

var cljs$core$async$impl$protocols$Handler$blockable_QMARK_$dyn_15362 = (function (h){
var x__5393__auto__ = (((h == null))?null:h);
...
return cljs$core$async$impl$protocols$Handler$blockable_QMARK_$dyn_15362(h);
}
});

var cljs$core$async$impl$protocols$Handler$commit$dyn_15369 = (function (h){
var x__5393__auto__ = (((h == null))?null:h);
...
return cljs$core$async$impl$protocols$Handler$commit$dyn_15369(h);
}
});
...
var cljs$core$async$impl$protocols$Buffer$full_QMARK_$dyn_15370 = (function (b){
...
return cljs$core$async$impl$protocols$Buffer$full_QMARK_$dyn_15370(b);
}
});

var cljs$core$async$impl$protocols$Buffer$remove_BANG_$dyn_15376 = (function (b){
var x__5393__auto__ = (((b == null))?null:b);
...
return cljs$core$async$impl$protocols$Buffer$remove_BANG_$dyn_15376(b);
}
});

var cljs$core$async$impl$protocols$Buffer$add_BANG__STAR_$dyn_15378 = (function (b,itm){
var x__5393__auto__ = (((b == null))?null:b);
...
return cljs$core$async$impl$protocols$Buffer$add_BANG__STAR_$dyn_15378(b,itm);
}
});

var cljs$core$async$impl$protocols$Buffer$close_buf_BANG_$dyn_15380 = (function (b){
var x__5393__auto__ = (((b == null))?null:b);
...
return cljs$core$async$impl$protocols$Buffer$close_buf_BANG_$dyn_15380(b);
}
});
